    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Mantenimiento :@{{ detalle }}</h4>
            ...
            <form id="form_registrar" class="form-horizontal"  data-parsley-validate novalidate>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" v-show="activando && activando3 " id="username_register"  class="btn btn-primary waves-effect waves-light">
                        Registrar
                    </button>
