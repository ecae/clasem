    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header ">
                ...
                <h4 class="modal-title" id="myModalLabel" style="color: red">Eliminar Orden de Trabajo</h4>
            </div>
            <form id="form_eliminar" class="form-horizontal"  data-parsley-validate novalidate>
            <div class="modal-body">
                <h3 style="color: red">Desea eliminar la Orden de Tabajo: <span id="nombre_ordentrabajo"></span> ?</h3>
                <input type="hidden" name="_token" value="{{ csrf_token() }}" id="token2">
                <input type="hidden" id="id_ordenTrabajo">
